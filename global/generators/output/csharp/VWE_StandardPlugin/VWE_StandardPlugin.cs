...
namespace VWE_StandardPlugin
{
    [BepInPlugin(PluginInfo.PLUGIN_GUID, PluginInfo.PLUGIN_NAME, PluginInfo.PLUGIN_VERSION)]
    public class VWE_StandardPlugin : BaseUnityPlugin
    {
        private const string PluginGUID = "VWE_StandardPlugin";
        private const string PluginName = "VWE_StandardPlugin";
    ...
    {
        public const string PLUGIN_GUID = "VWE_StandardPlugin";
        public const string PLUGIN_NAME = "VWE_StandardPlugin";
